      ...
      >
        <div className="sm:w-[50vw] w-[100%] flex flex-col justify-start mt-[3rem]">
          ...
          <p className="text-[#fff] text-[16px] text-justify mb-4">
            I am an experienced and detail-oriented Software Developer dedicated to creating intuitive and impactful digital experiences...
          </p>
          <p className="text-[#fff] text-[16px] text-justify">
            I have collaborated with diverse teams, including developers, marketers, and product managers...
          </p>
        </div>
      </section>
